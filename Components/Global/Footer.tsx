    ...
    <footer className="bg-[#090E34] text-white py-10">
      <div className="w-[85%] mx-auto flex flex-wrap justify-between border-b p-5">
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-4 sm:mb-0">
          <h1 className="text-[44px] font-bold">Let's Talk!</h1>
          <h3 className="text-gray-300 font-bold mt-4">Contact Info</h3>
          <p className="text-sm">closerpage@email.com</p>
          <p className="text-sm">123-456-7890</p>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-4 sm:mb-0">
          <h2 className="mb-2">What I Do?</h2>
          <ul className="text-sm">
            <li className="text-[10px]">Web Development</li>
            <li className="text-[10px]">UI/UX Design</li>
            <li className="text-[10px]">Content Creation</li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-4 sm:mb-0">
          <h2 className="mb-2">Quick Links</h2>
          <ul className="text-sm">
            <li className="text-[10px]"><a href="#">Home</a></li>
            <li className="text-[10px]"><a href="#">About</a></li>
            <li className="text-[10px]"><a href="#">Services</a></li>
            <li className="text-[10px]"><a href="#">Contact</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-4 sm:mb-0">
          <h2>Subscribe</h2>
          ...
          <form className="flex items-center mt-2">
            <input
              ...
              className="bg-gray-100 p-1 px-2 rounded-l-full w-full sm:w-auto"
            />
            <button className="bg-blue-500 text-white p-2 rounded-r-full text-sm">
              Subscribe
            </button>
          </form>
        </div>
